...
#SBATCH --job-name=amba_supervised             # Job name
#SBATCH --output=out/amba_supervised_%j.out    # Standard output log (%j adds job ID)
#SBATCH --error=err/amba_supervised_%j.err     # Standard error log
...
# Construct the run_supervised.sh command
RUN_CMD="$SLURM_TMPDIR/ssamba_project/src/run_supervised.sh \
...
# Make run_supervised.sh executable
echo "Making run_supervised.sh executable..."
chmod +x "$SLURM_TMPDIR/ssamba_project/src/run_supervised.sh"
